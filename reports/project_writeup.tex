...
Finally, we merged the CRSP and S12 data, and ultimately created a 
...
repeat the same regression. Finally, for Panel C, we classified the funds according to index fund status. 
