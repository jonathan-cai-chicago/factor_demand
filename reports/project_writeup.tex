...
the data, took many hours, which was the primary challenge of replicating table 2. We began by using the same sample of 
...
Here are some of our summary statistics of the data: 

We created a \hyperref[fig:image1]{yearly average return plot} that shows which years the funds were good
to invest in and the years they were not as much. In this graph, we see the significant impact of the 2008 crisis
...
most funds made money other than the EDYS funds. Then, we created a plot that counted the number 
