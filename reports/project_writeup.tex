...
\begin{table}[ht]
    ...
    \input{./dummy_table.tex}  
\end{table}
    

% \begin{table}[ht]
%     \centering
%     \caption*{CRSP Total Net Assets, Returns, and Net Asset Values}
%     \label{tab:table_crsp_t2}
%     \input{../output/table_crsp_t2.tex}
% \end{table}

% \begin{table}[ht]
%     \centering
%     \caption*{Fama-French Factor Returns}
%     \label{tab:table_fama_french_t2}
%     \input{../output/table_fama_french_t2.tex}
% \end{table}
